...
<h5 class="p-0 m-0 ">Vagas denunciadas</h5>
...
<form action="{{ route('denunciaVaga.destroy', $denuncia->idDenunciaVaga) }}" method="POST" class="d-inline">
    @csrf
    @method('DELETE')
